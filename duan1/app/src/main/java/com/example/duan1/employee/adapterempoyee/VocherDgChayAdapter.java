...
public class VocherDgChayAdapter extends RecyclerView.Adapter<VocherDgChayAdapter.MyViewHolder> {
    private Context context;
    private ArrayList<DangChay> list;

    public VocherDgChayAdapter(Context context, ArrayList<DangChay> list) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_voucherdgchay, parent, false);
