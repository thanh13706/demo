...
public class SanPhamUongAdapter extends RecyclerView.Adapter<SanPhamUongAdapter.MyViewHolder> {
    private Context context;
    private ArrayList<SanPhamUong> list;
    int bd=0;

    public SanPhamUongAdapter(Context context, ArrayList<SanPhamUong> list) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.item_sanphamuong,parent,false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view){
            super(view);
            image = view.findViewById(R.id.imgThemSanPhamUong);
            plus = view.findViewById(R.id.imgPlus);
            tvTitle = view.findViewById(R.id.tvTenSPU);


            tvPrice = view.findViewById(R.id.tvGia);
            cardSPPB = view.findViewById(R.id.cardSPU);

        }
    }
    public void diaLogThem(int position){
